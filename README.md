...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/orange-mouse-a2b3)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/orange-mouse-a2b3
```

A live public deployment of this template is available at [https://orange-mouse-a2b3.templates.workers.dev](https://orange-mouse-a2b3.templates.workers.dev)
